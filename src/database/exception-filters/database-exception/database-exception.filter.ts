...
export class DatabaseExceptionFilter extends BaseExceptionFilter {
  ...
  private createErrorData(code: string, message: string) {
    ...
    switch (code) {
      case this.DatabaseErrorCode.ASSOCIATION_NOT_FOUND_NOT_NULL_VIOLATION:
        ...
        if (message.includes(this.MessageSnippet.NOT_NULL_VIOLATION)) {
  ...
  private readonly DatabaseErrorCode = {
    ASSOCIATION_NOT_FOUND_NOT_NULL_VIOLATION: '23503',
